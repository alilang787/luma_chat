...
import '/screens/user-auth/s_google_post_auth.dart';
import '/screens/user-auth/s_twitter_post_auth.dart';
import '/screens/user-auth/s_usr_login.dart';
import '/screens/user-auth/s_usr_signup.dart';
import '/screens/user-auth/widgets/w_loading.dart';
...
class _UserAuthMainState extends ConsumerState<UserAuthMain> {
  ...
  void _xSignUp() async {
    String XapiKey = dotenv.env['XapiKey'] ?? 'No API Key Found';
    String XapiSecretKey = dotenv.env['XapiSecretKey'] ?? 'No API Key Found';
    String XredirectURI = dotenv.env['redirectURI'] ?? 'No API Key Found';
