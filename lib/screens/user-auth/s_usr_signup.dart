...
import '/screens/user-auth/widgets/w_back_button.dart';
import '/screens/user-auth/widgets/w_loading.dart';
import '/screens/user-auth/widgets/w_padText.dart';
...
class _UsrSignUpState extends State<UsrSignUp> with WidgetsBindingObserver {
  ...
  void _onSubmit() async {
    ...
    await prefs.setString('username', _username!.toLowerCase());
